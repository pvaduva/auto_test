...
class KillMajorCriticalProcess():
    ...
    def test_kill_pmond_process(self):
        ...
        cmd = "echo 'li69nux' |sudo -S mv /usr/local/bin/pmond /usr/local/bin/pmond.save"
        print cmd
        ...
        self.wait_until_host_state_equals(host_name,
                                                 ...
                                                 'degraded', timeout=30)
        # Restore pmond
        cmd_2 = "cp /usr/local/bin/pmond.save /usr/local/bin/pmond"
...
if __name__ == "__main__":
    ...
    process_kill.test_kill_pmond_process()
