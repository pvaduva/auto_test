...
class BmcQuantaConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #self.base_url = "http://%s/" % NODE_OAM_ADDRESS_2
        ...
        ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("source /etc/nova/openrc; system host-list")
        self.print_out (ssh_stdout.readlines())
