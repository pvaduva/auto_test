...
# Dell 720-1/2
NODE_OAM_ADDRESS_4='128.224.150.130'
CONTROLLER_0_ADDRESS='192.168.204.3'
CONTROLLER_0_MAC='c8:1f:66:e0:ff:01'
    ...
    def setUp(self):
        ...
        if LocateSensor.get_sensors("controller-0"):
            for a_name in alarm_group:
                LocateSensor.set_sensor_action("controller-0", "log", 'critical', a_name)
        else:
           return
        ...
        ssh.connect("%s" % NODE_OAM_ADDRESS_4, username="wrsroot", password="li69nux")
        ...
        os.system("expect ./sendfile.exp %s %s" % ("../clear_alarms/show_quanta", NODE_OAM_ADDRESS_4))
