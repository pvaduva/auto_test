...
CONT_USER = $env.NODE.target.Connect.ssh_user 
CONT_PASSWD = $env.NODE.target.Connect.ssh_pass 
CISCO_IP = $env.NODE.target.Infra.ciscoIP
CISCO_USER = $env.NODE.target.Infra.ciscoUser 
CISCO_PASSWD = $env.NODE.target.Infra.ciscoPasswd 
...
Con1SSH CONTINUEIF \| [a-z0-9-]{36} \| infra0(\s)*\| infra(\s)*\| ethernet \| \[u\'eth[0-9]*\'\](\s)*\| [0-9]* \| None
Con1SSH WAIT 5 SEC
