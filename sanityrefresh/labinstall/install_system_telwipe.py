...
def main():
    ...
    if args.bld_server_wkspace != "":
        bld_server_wkspce = args.bld_server_wkspace
    else:
        ...
        if wipedisk:
            ...
            for node in reversed(nodes):
                with open(os.devnull, 'wb') as devnull:
                    isNodeOnline = subprocess.call(
                        ["ping", "-w {}".format(PING_TIMEOUT), "-c 4", "{}".format(node.host_ip)], stdout=devnull,
