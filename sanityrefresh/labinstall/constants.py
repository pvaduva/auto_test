...
LICENSE_FILEPATH_R2 = " -L /folk/cgts/lab/TiS15-full.lic"
LICENSE_FILEPATH_R3 = " -L /folk/cgts/lab/TiS16-full.lic"
LICENSE_FILEPATH_R4 = " -L /folk/cgts/lab/TiS17-full.lic"
LICENSE_FILEPATH_R5 = " -L /folk/cgts/lab/R5-full.lic"
LICENSE_FILEPATH = "-L /folk/cgts/lab/R6-full.lic"
SFP_LICENSE_FILEPATH_R2 = "-L /folk/cgts/lab/TiS15-CPE-full.lic"
SFP_LICENSE_FILEPATH_R3 = "-L /folk/cgts/lab/TiS16-CPE-full.lic"
SFP_LICENSE_FILEPATH_R4 = "-L /folk/cgts/lab/TiS17-CPE-full.lic"
SFP_LICENSE_FILEPATH_R5 = "-L /folk/cgts/lab/R5-AIO-DX-full.lic"
SFP_LICENSE_FILEPATH = "-L /folk/cgts/lab/R6-AIO-DX-full.lic"
SIMPLEX_LICENSE_FILEPATH_R4 = "-L /folk/cgts/lab/TiS17-AIO-Simplex-full.lic"
SIMPLEX_LICENSE_FILEPATH_R5 = "-L /folk/cgts/lab/R5-AIO-SX-full.lic"
...
BOOT_IMAGE_ISO_TMP_PATH = "/home/wrsroot/" + BOOT_IMAGE_ISO
...
BIOS_TYPE_FN_HUMAN_READ = ['F6', 'ESC + @', 'F12', 'F11', 'ESC + !']
INSTALL_TIMEOUTS = [2400, 2400, 2400, 2400, 2400]
# Some labs take longer that 2100 seconds to install; increased to 2400.
