...
class BuildServerPath:
    ...
    DEFAULT_HOST_BUILDS_DIR = '/localdisk/loadbuild/jenkins/CGCS_6.0_Host' #formerly CGCS_5.0_Host, TC_18.03_Host
    DEFAULT_GUEST_IMAGE_PATH = '/localdisk/loadbuild/jenkins/CGCS_6.0_Guest/latest_build/export/tis-centos-guest.img' # formerly CGCS_5.0_Guest, TC_18.03_Guest
