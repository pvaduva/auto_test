...
class FlavorsPage(basepage.BasePage):
    ...
    def __init__(self, driver):
        super(FlavorsPage, self).__init__(driver)
    ...
    def create_flavor(self, name, id_=DEFAULT_ID, vcpus=None, ram=None,
                      root_disk=None, ephemeral_disk=None, swap_disk=None, rxtx_factor=None):
    ...
    def update_flavor_access(self, name, project_names, allocate=True):
        row = self._get_flavor_row(name)
