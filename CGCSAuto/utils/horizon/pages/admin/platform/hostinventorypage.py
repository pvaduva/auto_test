...
class MemoryTable(tables.TableRegion):
    ...
    def create_memory_profile(self, create_button):
        create_button.click()
        self.wait_till_spinner_disappears()
        return forms.TabbedFormRegion(self.driver, field_mappings=self.CREATE_MEMORY_PROFILE_FORM_FIELDS)
...
class StoragePartitionsTable(tables.TableRegion):
    ...
    def create_new_partition(self, create_button):
        ...
        self.wait_till_spinner_disappears()
        return forms.TabbedFormRegion(self.driver,
                                      field_mappings=self.CREATE_PARTITION_FORM_FIELDS)
...
class StorageLocalVolumeGroupTable(tables.TableRegion):
    ...
    def create_storage_profie(self, create_button):
        ...
        self.wait_till_spinner_disappears()
        return forms.TabbedFormRegion(self.driver,
                                      field_mappings=self.CREATE_STORAGE_PROFILE_FORM_FIELDS)
...
class StoragePhysicalVolumeTable(tables.TableRegion):
    ...
    def add_physical_volume(self, add_button):
        ...
        self.wait_till_spinner_disappears()
        return forms.TabbedFormRegion(self.driver,
                                      field_mappings=self.ADD_PHYSICL_VOLUME_FORM_FIELDS)
...
class InterfaceTable(tables.TableRegion):
    ...
    def create_inferface_profile(self, create_button):
        ...
        self.wait_till_spinner_disappears()
        return forms.TabbedFormRegion(self.driver,
                                      field_mappings=self.CREATE_INTERFACE_PROFILE_FORM_FIELDS)
...
class HostInventoryDetailPage(basepage.BasePage):
    ...
    def get_horizon_row_dict(self, table_, key_header_index):
        ...
        Return:
            A row dict table, the unique column value as a key, usually are uuid or name
        Examples:
            {
            '53194b0f-543c-4b33-9b2e-276ab9c70671': {'uuid': 53194b0f-543c-4b33-9b2e-276ab9c70671, 'type': 'SSD'...}
            'ea89031c-8f60-41b0-ad14-c5fcf5df96eb': {'uuid': ea89031c-8f60-41b0-ad14-c5fcf5df96eb, 'type': 'SSD'...}
            }
        """
        rtn_dict = {}
