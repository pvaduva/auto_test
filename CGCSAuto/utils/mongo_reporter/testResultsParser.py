...
def extract_result(line):
    ...
    if match_result:
        ...
        if detail_re['failed'] == 1 or detail_re['errors'] == 1 or detail_re['skip'] == 1:
    ...
    def extract_noseresult(lines):
        ...
        for l in lines:
            ...
            if match_result is not None:
                result['passed'] += match_result['passed']
