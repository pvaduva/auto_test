...
01h,25jan13,srr  Split-out SingleCmdExec to z_del_cmdutils.py
...
from mongo_reporter import z_del_cmdutils

# import name change for backwards compatibility with MILS scripts
SingleCmdExec = z_del_cmdutils.CmdExec

log = logging.getLogger(__name__)

# default SSH key generation script
GENSSHKEYS_SCRIPT_DEFAULT = "z_del_genSSHKeys.sh"
...
class SshConn():
    ...
    def __init__(self, host, username, password, port=22, sshCustomConf=True,
        ...
        self.cmdExec = z_del_cmdutils.CmdExec(timeout=timeout, retries=retries)
    ...
    def checkPIDRemote(self, pid, timeout=True, retries=None):
        ...
        except z_del_cmdutils.CmdRCError:
            return False
