# Test obsolete - ceph is the default config for all system types now
...
#     storage_helper, glance_helper, vm_helper
...
#
#     controller0_disks = storage_helper.get_host_disks(controller0, field='device_node')
#     controller1_disks = storage_helper.get_host_disks(controller1, field='device_node')
#
#     rootfs = keywords.system_helper.get_host_values(controller0, "rootfs_device")[0]
#     if '/dev/disk/by-path' in rootfs:
#         rootfs = storage_helper.get_host_disks(controller0, field='device_node', device_path=rootfs)[0]
#     elif '/dev/' not in rootfs:
#         rootfs = '/dev/{}'.format(rootfs)
#     size = storage_helper.get_host_disk_values(controller0, disk=rootfs, fields='size_gib')[0]
#     controller0_rootfs = [rootfs, int(size)]
#
#     rootfs = keywords.system_helper.get_host_values(controller1, "rootfs_device")[0]
#     if '/dev/disk/by-path' in rootfs:
#         rootfs = storage_helper.get_host_disks(controller1, field='device_node', device_path=rootfs)[0]
#     elif '/dev/' not in rootfs:
#         rootfs = '/dev/{}'.format(rootfs)
#     size = storage_helper.get_host_disk_values(controller1, disk=rootfs, fields='size_gib')[0]
#
...
#
#     backend_info = storage_helper.get_storage_backend_values('lvm', rtn_dict=True)
...
#             size_0 = storage_helper.get_host_disk_values(controller0, disk=common_ceph_mon_dev[0], fields='size_gib')[0]
#             size_1 = storage_helper.get_host_disk_values(controller1, disk=common_ceph_mon_dev[0], fields='size_gib')[0]
#             controller0_ceph_mon_dev = [common_ceph_mon_dev[0], int(size_0)]
#             controller1_ceph_mon_dev = [common_ceph_mon_dev[0], int(size_1)]
#         else:
#             size_0 = storage_helper.get_host_disk_values(controller0, disk=controller0_spare_devices[0],
#                                                          fields='size_gib')[0]
#             size_1 = storage_helper.get_host_disk_values(controller0, disk=controller1_spare_devices[0],
#                                                          fields='size_gib')[0]
...
#
#     infra = keywords.host_helper.get_host_interfaces("controller-0", net_type='infra')
#     return len(infra) > 0
#
#
...
#         uuid_0 = storage_helper.get_host_disks('controller-0', field='uuid', device_node=dev_0)
#         dev_1 = controller1_info['ceph_mon_dev'][0]
#         uuid_1 = storage_helper.get_host_disks('controller-1', field='uuid', device_node=dev_1)
#
...
#     image_names = glance_helper.get_images(field='name')
...
#     # source_image = '{}/{}'.format(GuestImages.DEFAULT['image_dir'], current_images[0])
...
#     values = storage_helper.get_controllerfs_list()
#     total_used = 0
#     for value in values:
#         if value:
