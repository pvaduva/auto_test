...
def test_setup(lab_name, controller, compute, storage, lab_files_server, lab_files_dir):
    install_path = write_installconf(lab=lab_name, controller=controller,
                                     ...
                                     iso_path=None, security="standard", low_latency=False)
...
boot_menu = menu.USBBootMenu()
print(boot_menu.sub_menus)
for sub_menu in boot_menu.sub_menus:
    print("sub menu name: {}".format(sub_menu.name))
