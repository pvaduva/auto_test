...
#
# Obsolete - Replaced by CGCSAuto/tc_bnr
#
...
#         if cinder_helper.get_volume_show_values(vol_id, 'status')[0] == 'available':
...
#         if cinder_helper.get_volume_show_values(vol_id, 'status')[0] == 'in-use':
