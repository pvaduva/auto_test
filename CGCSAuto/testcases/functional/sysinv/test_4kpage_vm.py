...
def test_live_migrate_4k_vm_positive(storage_backing, ephemeral, swap, cpu_pol, vcpus, vm_type,
...
def _boot_vm_under_test(storage_backing, ephemeral, swap, cpu_pol, vcpus, vm_type):
    ...
    vm_id = vm_helper.boot_vm('4k_mig', flavor=flavor_id, source=boot_source)[1]
    ResourceCleanup.add('vm', vm_id)
