...
def test_modify_memory_when_unlocked_negative():
    """
    ...
    exit_code, output = cli.system('host-memory-modify', args, fail_ok=True, rtn_list=True)
...
def test_modify_hugepages_positive(host_to_modify, proc, huge_pages):
    """
...
class TestHugepageNegative:
    ...
    def test_invalid_huge_page_input(self, host_to_modify, proc, pages):
        """
