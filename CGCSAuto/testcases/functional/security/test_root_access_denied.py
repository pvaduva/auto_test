...
def keyfile_setup(request):
    ...
    with con_ssh.login_as_root() as root_ssh:
        ...
        root_ssh.exec_cmd('cat '+sysadmin_keyfile+'  >> /home/root/.ssh/authorized_keys')
    ...
    def delete_keyfile():
        ...
        con_ssh.exec_cmd('rm /home/sysadmin/id_rsa.pub')
