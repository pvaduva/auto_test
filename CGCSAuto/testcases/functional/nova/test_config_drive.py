...
from keywords import vm_helper, host_helper, cinder_helper, glance_helper, system_helper
...
def test_vm_with_config_drive(hosts_per_stor_backing):
    ...
    vm_id = vm_helper.boot_vm(name='config_drive', config_drive=True, block_device=block_device,
