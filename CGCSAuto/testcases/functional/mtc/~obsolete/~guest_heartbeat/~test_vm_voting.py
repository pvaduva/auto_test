...
#     """
#     if action == 'migrate':
#         vm_host = keywords.vm_helper.get_vm_host(vm_id)
...
#             assert keywords.vm_helper.get_vm_host(vm_id) == vm_host, "The vm voted against migrating but was live migrated"
...
#             assert keywords.vm_helper.get_vm_host(vm_id) == vm_host, "The vm voted against migrating but was cold migrated"
#             vm_helper.wait_for_vm_pingable_from_natbox(vm_id, timeout=30)
#
#         else:
...
#                                                              destination_host=dest_host)
#             vm_host_2 = keywords.vm_helper.get_vm_host(vm_id)
...
#             vm_host_3 = keywords.vm_helper.get_vm_host(vm_id)
#             assert return_code in [0, 1] and ('action-rejected' not in message), message
...
#             vm_state = keywords.vm_helper.get_vm_status(vm_id)
#             LOG.info(out)
