...
#     time.sleep(30)
#     compute_name = keywords.vm_helper.get_vm_host(vm_id)
...
#     assert expt_host == keywords.vm_helper.get_vm_host(vm_id), "VM is recovered onto a different host"
#     vm_helper.wait_for_vm_pingable_from_natbox(vm_id)
