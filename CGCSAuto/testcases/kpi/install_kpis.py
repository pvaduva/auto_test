...
def test_config_controller_kpi():
    ...
    host = "controller-0"
    local_kpi_file = "~/AUTOMATION_LOGS/kpi/config_controller.txt"
...
def test_lab_setup_kpi():
    ...
    host = "controller-0"
    local_kpi_file = "~/AUTOMATION_LOGS/kpi/lab_setup.txt"
...
def test_heat_kpi():
    ...
    host = "controller-0"
    local_kpi_file = "~/AUTOMATION_LOGS/kpi/heat_stacks.txt"
